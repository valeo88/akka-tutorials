package essentials.infrastucture
...
/** Routers used to delegate messages to N identical actors */
object Routers extends App {
  ...
  class Master extends Actor {
    ...
    private val slaves = for(i <- 1 to 5) yield {
      ...
      context.watch(slave)
      // ActorRefRoutee send message to ActorRef
    ...
    override def receive: Receive = {
      ...
      case Terminated(ref) =>
        ...
        // create copy of router - need var
