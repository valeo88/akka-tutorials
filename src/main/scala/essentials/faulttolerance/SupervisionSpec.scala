...
object SupervisionSpec {
  ...
  class Supervisor extends Actor {
    ...
    override val supervisorStrategy: SupervisorStrategy = OneForOneStrategy() {
      case _: NullPointerException => Restart // Discards the old Actor instance and replaces it with a new, then resumes message processing.
      case _: IllegalArgumentException => Stop // Stops the Actor
      case _: RuntimeException => Resume // Resumes message processing for the failed Actor
      case _: Exception => Escalate // Escalates the failure to the supervisor of the supervisor,
    }
